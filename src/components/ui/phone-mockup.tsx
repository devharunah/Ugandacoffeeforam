  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="border-foreground/5 bg-background dark:border-foreground/10 relative z-10 overflow-hidden rounded-[35px] border-10 shadow-lg"
        style={{
          transformStyle: 'preserve-3d',
          perspective: '1000px',
      ...
      >
        ...
        <div className="bg-foreground/20 absolute top-16 -right-3.5 h-12 w-1 rounded-l-sm"></div>
        <div className="bg-foreground/20 absolute top-16 -left-3.5 h-8 w-1 rounded-r-sm"></div>
        <div className="bg-foreground/20 absolute top-28 -left-3.5 h-8 w-1 rounded-r-sm"></div>
