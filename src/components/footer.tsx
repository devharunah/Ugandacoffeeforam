    ...
    return (
        <footer className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    <Link
                        href="https://www.linkedin.com/in/kakooza-harunah-701882350/"
                        target="_blank"
                    ...
                    <Link
                        href="https://www.threads.com/@kakooza_harunah"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="Threads"
                        className="text-muted-foreground hover:text-primary block">
                    ...
                    <Link
                        href="https://www.instagram.com/kakooza_harunah/"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <Link
                        href="https://www.tiktok.com/@devharunah"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="TikTok"
                        className="text-muted-foreground hover:text-primary block">
